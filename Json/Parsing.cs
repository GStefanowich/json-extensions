...
namespace TheElm.Text.Json {
    public static class Parsing {
        ...
        public static bool TryParseJSON<TO>(this string @string, [MaybeNullWhen(false)] out TO jObject, JsonSerializerOptions? options = null) {
            try {
        ...
        /// <summary>Try converting the provided String into a JSON Object</summary>
        public static bool TryParseJSON(this string @string, [MaybeNullWhen(false)] out JsonObject jObject, JsonSerializerOptions? options = null) {
            try {
        ...
        public static bool TryParseJSON(this string @string, [MaybeNullWhen(false)] out JsonArray jArray, JsonSerializerOptions? options = null) {
            try {
                JsonDocument document = JsonDocument.Parse(@string, options?.GetDocumentOptions() ?? default);
        ...
        /// <summary>Try converting the provided String into a JSON Array</summary>
        public static bool TryParseJSON(this string @string, [MaybeNullWhen(false)] out JsonNode jNode, JsonSerializerOptions? options = null) {
            try {
